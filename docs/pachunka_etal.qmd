...
load(here("R/pachunka_etal_2024.RData"))
# source(here("R/pachunka_etal_2024_rcode.R"))

my_citations <- cite_r(file = here("docs/r-references.bib"), pkgs = c("BayesFactor", "cocoon", "flextable", "ggbeeswarm", "here", "gtsummary", "Hmisc", "labelled", "lavaan", "papaja", "patchwork", "psych", "semTable", "tidyverse"), withhold = FALSE)
...
#| fig-alt: "Two sub-figures: The top sub-figure is for Study 1 and the bottom sub-figure is for Study 2. Both sub-figures show beeswarm plots and means and 95% confidence intervals for 11 different scores (HAI activities, attachment, commitment, perception of animal use, caring, character, competence, confidence, connection, depression, and anxiety/self-regulation) as a function of 4-H/FFA membership (Yes/No)."

knitr::include_graphics(here("figures/group_diff_measures.png"))
